...
class Main(object):
    def setupUi(self, MODBUSSER):
        ...
        self.openAction = QtWidgets.QAction(MODBUSSER)
        self.openAction.setObjectName("openAction")
        self.exportAction = QtWidgets.QAction(MODBUSSER)
    ...
    def retranslateUi(self, MODBUSSER):
        ...
        self.openAction.setText(_translate("AR-CON ModBus", "Open   Ctrl+O"))
        self.exportAction.setText(_translate("AR-CON ModBus", "Save     Ctrl+S"))
