...
class Dialog(object):
    def setupUi(self, set_win):
        ...
        self.sbSet = QtWidgets.QComboBox(set_win)
        self.sbSet.setObjectName("sbSet")
        self.gridLayout.addWidget(self.sbSet, 3, 2, 1, 3)
        ...
        self.baudSet = QtWidgets.QComboBox(set_win)
        self.baudSet.setObjectName("baudSet")
        self.gridLayout.addWidget(self.baudSet, 1, 2, 1, 3)
        ...
        self.comSet = QtWidgets.QComboBox(set_win)
        self.comSet.setObjectName("comSet")
        self.gridLayout.addWidget(self.comSet, 0, 2, 1, 3)
        self.paritySet = QtWidgets.QComboBox(set_win)
        self.paritySet.setObjectName("paritySet")
        self.gridLayout.addWidget(self.paritySet, 2, 2, 1, 3)
